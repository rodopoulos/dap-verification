...
\begin{enumerate}
  ...
  \item No legal agent can extend his knowledge with any of the message received by any smartphone in a trace, since he already knows given the case of \texttt{Inputs} event. However, if the smartphone is compromised, the Spy can learn any information it receives;
  %
  \begin{center}
